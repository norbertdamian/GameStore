...
{
    public partial class NewExtendedModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublishedGame", x => new { x.GameID, x.PublisherID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublishedGame_Publisher_PublisherID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublishedGame_PublisherID",
                table: "PublishedGame",
                column: "PublisherID");
        }
